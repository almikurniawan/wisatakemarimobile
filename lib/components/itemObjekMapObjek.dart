...
class ItemObjekMapObjek extends StatefulWidget {
  final dynamic data;
  final ValueSetter<dynamic> onDetail;
  const ItemObjekMapObjek({Key key, this.data, this.onDetail}) : super(key: key);

  @override
  _ItemObjekMapObjekState createState() => _ItemObjekMapObjekState();
}

class _ItemObjekMapObjekState extends State<ItemObjekMapObjek> {
